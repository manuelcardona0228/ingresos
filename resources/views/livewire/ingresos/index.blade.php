            ...
            @if(count($ingresos))
                ...
                <div class="lg:flex shadow rounded-lg mt-2 mb-2">
                    ...
                    <div class="flex flex-row lg:justify-start justify-center">
                        ...
                        <i class="far fa-clock"></i> {{ \Carbon\Carbon::parse($ingreso->created_at)->isoFormat('MMMM DD YYYY, hh:mm:ss') }}
                        </div>
                        <div class="text-gray-700 font-medium text-sm text-center lg:text-left px-2">
                    ...
                    <div class="text-gray-600 font-medium text-sm pt-1 text-center lg:text-left px-2">
                        {{ \Numeral::number($ingreso->valor)->format('$0,0') }}
                    </div>
                    </div>
                ...
                {{ $ingresos->links() }}
            @else
                @if($toLoad === true && count($ingresos) === 0)
